...
1. [**Reflexive validation**](https://github.com/env0-labs/env0.explore/blob/explore/formal_research/competence-without-trust-glossary.md#reflexive-validation), or the active assessment of a source’s trustworthiness  
2. [**Authenticity as a filtering mechanism**](https://github.com/env0-labs/env0.explore/blob/explore/formal_research/competence-without-trust-glossary.md#authenticity-filtering), in which perceived coherence or usefulness outweighs formal correctness  
3. [**Emergent competence**](https://github.com/env0-labs/env0.explore/blob/explore/formal_research/competence-without-trust-glossary.md#emergent-competence), the development of usable skill through iteration rather than certainty
